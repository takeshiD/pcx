...
## v0.1 MCAP vertical slice — planned

1. bounded synchronous MCAP reading;
2. metadata and Topic listing;
3. strict ROS 2 CDR decoding for `sensor_msgs/msg/PointCloud2`;
4. zero-copy `PointView` where possible;
5. select one Point Frame by index or MCAP log time;
6. write binary or ASCII PCD.
